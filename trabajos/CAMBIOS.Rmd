...
---
title: "Trabajo Final - Localización Óptima de Oferta de Servicios"
...
# 1. Carga y preparación de datos EPF

```{r carga-epf}
# Cargar datos EPF
personas <- read_dta("data/base-personas-ix-epf-stata.dta")
gastos <- read_dta("data/base-gastos-ix-epf-stata.dta")
...
- Se imputó exitosamente el gasto en hoteles en la CASEN 2022 usando modelos EPF.
- Se simularon zonas censales y cobertura teórica.
- Se identificaron zonas con alta demanda no cubierta como prioritarias.
- El análisis de clústeres permite segmentar el territorio para decisiones más informadas.
